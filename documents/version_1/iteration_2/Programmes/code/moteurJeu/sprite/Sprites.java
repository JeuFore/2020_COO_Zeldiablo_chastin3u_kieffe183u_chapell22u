...
public class Sprites {
	 ...
	 * 
	 * <pre>
	 * charge le morceau (x, y) -> (x+tx, y+ty) de l'image souhaite nomFichier
	...
	/**
	 * permet de charger une feuille de sprite rguliere  partir de la feuille
	...
	/**
	 * permet de dessiner l'image de anire centree sur le graphics
	 * 
	 * @param g
	 *            graphics avec lequel dessiner
	 * @param x
